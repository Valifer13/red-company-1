...
<body>
			...
			<div class="row justify-content-between align-items-center">
				<div class="col-xl-6 col-lg-7">
					<div class="page__banner-content">
						<h2>Transformasi digital untuk perusahaan ritel</h2>
    ...
    <div class="project__details section-padding">
        <div class="container">
			<div class="row gy-4 mb-40 justify-content-center">
				<div class="col-xl-4 col-lg-5">
					<div class="project-feature">
						<h4>Database Management</h4>
						<div class="project-feature-icon">
							<img src="assets/img/icon/project-details-icon.png" alt="image">
						</div>
					</div>
				</div>
				<div class="col-xl-4 col-lg-5">
			...
			<div class="row">
				<div class="col-xl-12">
					<div class="project__details-thumb">
						<img src="assets/img/gallery/gallery-2.png.jpeg" alt="image">
						<div class="project-info">
							<div class="project-info-top">
								<h4>Project Details</h4>
							</div>
							<ul>
								<li>Name:<span>Transformasi Digital untuk perusahaan ritel</span></li>
								<li>Author:<span>Admin</span></li>
								<li>Date:<span>23 December,2023</span></li>
								<li>Tags:<span>DataMasters</span></li>
								<li>Value:<span class="value">$ 240</span></li>
				...
				<div class="col-xl-8">
					<div class="project__details-content">
						<div class="project__details-content-mid">
							<h3>Tujuan</h3>
							<p>Tujuan dari project kami di sini adalah Merombak sistem IT perusahaan ritel besar untuk meningkatkan efisiensi operasional dan pengalaman pelanggan dengan solusi perangkat lunak kustom dan strategi pemasaran digital.</p>
							<h3>Tantangan</h3>
							<p>Tentunya terdapat tantangan yang kami hadapi ketika membuat project ini, yakni Migrasi data tanpa mengganggu operasional, serta integrasi sistem lama dengan platform e-commerce baru yang harus menangani transaksi tinggi.</p>
							<h3>Solusi</h3>
							<p>Tentunya untuk mengatasi hal ini kami mengimplementasikan sistem manajemen inventaris dan platform e-commerce terintegrasi, serta kampanye pemasaran digital yang mencakup SEO dan media sosial.</p>
						</div>
					</div>
				</div>
				<div class="project__details-images">
					<img src="assets/img/project/project-details.png" alt="image">
					<img src="assets/img/project/project-details-2.png" alt="image">
				</div>
				<div class="project__details-content">
					<div class="project__details-content-bottom">
						<h3>Hasil</h3>
						<p>Dan hasil yang kami peroleh adalah Peningkatan efisiensi operasional sebesar 30%, penjualan online naik 25%, dan kepuasan pelanggan meningkat dari 75% menjadi 90%.</p>
					</div>
				</div>
			</div>
        </div>
