			...
			<form action="#">
				<div class="request-quote__area-inputs">
					<div class="request-quote__area-input-field">
						...
						<input type="text" id="first-name" placeholder="Depan">
					</div>
					<div class="request-quote__area-input-field">
						<label for="last-name">Nama Belakang *</label>
						<input type="text" id="last-name" placeholder="Belakang">
					</div>
					<div class="request-quote__area-input-field">
					...
					<div class="request-quote__area-input-field">
						...
						<input type="text" id="number" placeholder="+62 831-1958-7745">
					</div>
					<div class="request-quote__area-input-field">
						<label for="company">Perusahaan/Organisasi *</label>
						<input type="text" id="company" placeholder="Red system">
					</div>
					<div class="request-quote__area-input-field">
						<label for="website">Website *</label>
						<input type="text" id="website" placeholder="https://redsystem.id">
					</div>
				</div>
				<div class="request-quote__area-service-input">
					<span>Layanan apa yang kami bisa sediakan untuk anda? *</span>
					<div class="request-quote__area-service-input-single">
						<input type="checkbox" id="seo">
						<label for="seo">Optimisasi (SEO)</label>
					</div>
					<div class="request-quote__area-service-input-single">
					...
					<div class="request-quote__area-service-input-single">
						...
						<label for="maintenance">Pemeliharaan</label>
					</div>
				</div>
				<label for="message" class="mb-2">Pesan *</label>
				<textarea id="message" placeholder="Tulis di sini"></textarea>
				<input type="submit" value="Kirim Sekarang" class="btn-two mt-4">
			</form>
		</div>
	</div>
	<!-- Request Quote End -->
