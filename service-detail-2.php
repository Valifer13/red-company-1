            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="service__details-content">
                        ...
                        <p>Kami mengembangkan perangkat lunak kustom yang aman dan skalabel untuk mendukung operasi bisnis Anda.</p>

                        <div class="service__details-content-box">
                            <div class="service__details-content-box-single">
                                <h4>Manfaat untuk bisnis anda</h4>
                                <p>Perangkat lunak kami meningkatkan efisiensi, produktivitas, dan fleksibilitas bisnis Anda.</p>
                            ...
                            <div class="service__details-content-box-single">
                                ...
                                <h4 class="mb-4">Bagaimana Kami Bekerja</h4>
                                <p class="m-0">Proses pengembangan kami fokus pada pemahaman kebutuhan bisnis, desain solusi yang sesuai, dan penggunaan teknologi terbaru dengan metodologi agile.</p>
                            </div>
                        </div>
				...
				<div class="row justify-content-between copyright__one-container-area">
					<div class="col-xl-5 col-lg-6"> 
						<div class="copyright__one-left">
							<p>© RedCompany  2024 | All Rights Reserved</p>
						</div>
					</div>
					<div class="col-xl-5 col-lg-6">
						<div class="copyright__one-right">
							<a href="about.php">Kebijakan Privasi</a>
