            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="service__details-content">
                        ...
                        <p>Kami mengintegrasikan berbagai sistem dan aplikasi untuk menciptakan aliran kerja yang efisien.</p>

                        <div class="service__details-content-box">
                            <div class="service__details-content-box-single">
                                <h4>Manfaat untuk bisnis anda</h4>
                                <p>Bisnis Anda akan lebih efisien, dengan biaya yang lebih rendah dan respons yang lebih cepat terhadap perubahan.</p>
                            ...
                            <div class="service__details-content-box-single">
                                ...
                                <p class="m-0">Kami menganalisis sistem yang ada dan merancang solusi integrasi yang memastikan semua komponen teknologi bekerja harmonis.</p>
                            </div>
                        </div>
