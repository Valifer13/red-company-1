            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="service__details-content">
                        ...
                        <p>Kami menyediakan layanan analitik data untuk membantu perusahaan membuat keputusan bisnis yang lebih baik.</p>

                        <div class="service__details-content-box">
                            <div class="service__details-content-box-single">
                                <h4>Manfaat untuk bisnis anda</h4>
                                <p>Anda akan mendapatkan wawasan yang mendalam untuk mengidentifikasi peluang dan mengurangi risiko.</p>
                            ...
                            <div class="service__details-content-box-single">
                                ...
                                <p class="m-0">Kami mengumpulkan, menganalisis, dan menyajikan data yang akurat untuk mendukung keputusan bisnis yang tepat.</p>
                            </div>
                        </div>
