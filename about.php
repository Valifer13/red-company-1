					...
					<div class="about__one-content">
						...
						<div class="about__one-content-service">
							<div class="service">
								...
								<span><b>Visi: </b>Menjadi pemimpin global dalam solusi teknologi inovatif.</span>
							</div>
							<div class="service">
								<i class="far fa-check-circle"></i>
								<span><b>Misi: </b>Memberikan nilai tambah kepada klien dengan layanan teknologi terdepan dan pendekatan yang disesuaikan.</span>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row align-items-end work-process-area__one-title">
				<div class="col-xl-7 col-lg-7">
					<div class="work-process-area__one-content-left">
						<span class="subtitle-one">Timeline</span>
						<h2>Narasi sejarah dari perusahaan kami</h2>
					</div>
				</div>
			</div>
				...
				<div class="col-xl-6">
					<div class="work-process-area__one-single-work">
						...
						<div class="work-process-area__one-single-work-content">
							<p>Didirikan dengan fokus pada pengembangan perangkat lunak.</p>
						</div>
					</div>
					<div class="work-process-area__one-single-work">
						<span>2010</span>
						<div class="work-process-area__one-single-work-content">
							<p>Eskpansi internasional</p>
						</div>
					</div>
					<div class="work-process-area__one-single-work">
						<span>2015</span>
						<div class="work-process-area__one-single-work-content">
							<p>Peluncuran platform e-commerce yang sukses.</p>
						</div>
					</div>
					<div class="work-process-area__one-single-work">
						<span>2020</span>
						<div class="work-process-area__one-single-work-content">
							<p>Diakui sebagai perusahaan teknologi inovatif.</p>
						</div>
					</div>
					<div class="work-process-area__one-single-work">
						<span>2024</span>
						<div class="work-process-area__one-single-work-content">
							<p>Meluncurkan layanan AI terbaru.</p>
						</div>
					</div>
				</div>
				<div class="col-xl-6">
				...
				<div class="col-xl-6 col-lg-6">
					<div class="testimonial__one-left" style="background-image: url(assets/img/testimonial/testimonial.png);">
						<div class="testimonial__one-left-title">
							...
							<a href="contact.html" class="btn-one">Daparkan Dukungan
