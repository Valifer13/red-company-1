			...
			<div class="row justify-content-between align-items-center">
				<div class="col-xl-6 col-lg-7">
					<div class="page__banner-content">
						<h2>Solusi analitik data untuk perusahaan keuangan</h2>
			...
			<div class="row">
				<div class="col-xl-12">
					<div class="project__details-thumb">
						<img src="assets/img/project/project-details-thumb.png" alt="image">
						<div class="project-info">
							<div class="project-info-top">
								<h4>Project Details</h4>
							</div>
							<ul>
								<li>Name:<span>Solusi analitik data untuk perusahaan keuangan</span></li>
								<li>Author:<span>Admin</span></li>
								<li>Date:<span>23 December,2023</span></li>
								<li>Tags:<span>Analistik</span></li>
				...
				<div class="col-xl-8">
					<div class="project__details-content">
						<div class="project__details-content-mid">
							<h3>Tujuan</h3>
							<p>Menyediakan solusi analitik data mendalam untuk perusahaan keuangan besar guna meningkatkan keputusan investasi dan efisiensi operasional.</p>
							<h3>Tantangan</h3>
							<p>Mengelola dan menganalisis volume data besar dari berbagai sumber sambil memastikan keamanan dan akurasi data.</p>
							<h3>Solusi</h3>
							<p>Implementasi platform analitik canggih yang memungkinkan visualisasi data real-time dan pelaporan otomatis, serta integrasi dengan sistem existing untuk memberikan wawasan yang dapat ditindaklanjuti.</p>
						</div>
					</div>
				</div>
				...
				<div class="project__details-content">
					<div class="project__details-content-bottom">
						<h3>Hasil</h3>
						<p>Perusahaan dapat mengidentifikasi tren pasar lebih cepat dan membuat keputusan investasi yang lebih informasional, meningkatkan efisiensi operasional sebesar 30%.</p>
					</div>
				</div>
			</div>
        </div>
