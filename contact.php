				...
				<div class="col-xl-6">
					<div class="contact__two-content">
						<div class="contact__two-title">
							<span class="subtitle-one">Kontak Kami</span>
							<h2>Apakah anda memiliki pertanyaan?</h2>
							<p>Kami senang mendengar dari Anda! Jika Anda memiliki pertanyaan, umpan balik, atau membutuhkan informasi lebih lanjut tentang layanan kami, jangan ragu untuk menghubungi kami. Tim kami siap membantu Anda dengan segala kebutuhan dan pertanyaan yang Anda miliki.</p>
						</div>
				...
				<div class="col-xl-6">
					<div class="contact__two-contact-info">
						...
						<div class="contact__two-single-info">
							...
							<div class="contact__two-single-info-content">
								<h4>Lokasi</h4>
								<span>Jl. Ratna No 68 G, Tonja, Denpasar Utara, Denpasar - Bali . 80239</span>
							</div>    
						</div>
					</div>
				</div>
