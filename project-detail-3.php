			...
			<div class="row justify-content-between align-items-center">
				<div class="col-xl-6 col-lg-7">
					<div class="page__banner-content">
						<h2>Pengembangan Aplikasi Mobile untuk startup teknologi</h2>
			...
			<div class="row">
				<div class="col-xl-12">
					<div class="project__details-thumb">
						<img src="assets/img/gallery/gallery-3.png.jpeg" alt="image">
						<div class="project-info">
							<div class="project-info-top">
								<h4>Project Details</h4>
							</div>
							<ul>
								<li>Name:<span>Pengembangan Aplikasi Mobile untuk startup teknologi</span></li>
								<li>Author:<span>Admin</span></li>
								<li>Date:<span>23 December,2023</span></li>
								<li>Tags:<span>AppDevelopment</span></li>
				...
				<div class="col-xl-8">
					<div class="project__details-content">
						<div class="project__details-content-mid">
							<h3>Tujuan</h3>
							<p>Mendesain dan mengembangkan aplikasi mobile canggih untuk startup teknologi guna mendukung pertumbuhan bisnis dan meningkatkan keterlibatan pengguna.</p>
							<h3>Tantangan</h3>
							...
							<h3>Solusi</h3>
							<p>Menggunakan teknologi terbaru untuk menciptakan antarmuka pengguna yang intuitif, serta fitur-fitur seperti notifikasi push dan integrasi dengan media sosial untuk meningkatkan keterlibatan.</p>
						</div>
					</div>
				</div>
