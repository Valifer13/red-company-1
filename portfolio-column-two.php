			...
			<div class="row">
				<div class="col-xl-6">
					<div class="portfolio__two-single-item">
						<div class="portfolio__two-single-item-img-wrapper">
							<img src="assets/img/gallery/gallery-1.png.jpeg" alt="image">
						</div>
				...
				<div class="col-xl-6">
					<div class="portfolio__two-single-item">
						...
						<div class="portfolio__two-single-item-content">
							<div class="portfolio__two-single-item-content-left">
								<h3>Transformasi digital untuk perusahaan ritel</h3>
								<p>Hosting Solution</p>
							</div>
							<div class="portfolio__two-single-item-content-right">
								<a href="project-detail-2.php">
									<i class="fas fa-arrow-right"></i>
								</a>
							</div>
						</div>
				...
				<div class="col-xl-6">
					<div class="portfolio__two-single-item">
						...
						<div class="portfolio__two-single-item-content">
							<div class="portfolio__two-single-item-content-left">
								<h3>Pengembangan Aplikasi Mobile untuk Startup Teknologi</h3>
								<p>App Development</p>
							</div>
							<div class="portfolio__two-single-item-content-right">
								<a href="project-detail-3.php">
									<i class="fas fa-arrow-right"></i>
								</a>
							</div>
						</div>
				...
				<div class="col-xl-6">
					<div class="portfolio__two-single-item">
						<div class="portfolio__two-single-item-img-wrapper">
							<img src="assets/img/gallery/gallery-4.png.jpeg" alt="image">
						</div>
						<div class="portfolio__two-single-item-content">
							<div class="portfolio__two-single-item-content-left">
								<h3>Solusi analitik data untuk perusahaan keuangan</h3>
								<p>Risk Management</p>
							</div>
							<div class="portfolio__two-single-item-content-right">
								<a href="project-detail-4.php">
									<i class="fas fa-arrow-right"></i>
								</a>
							</div>
						</div>
